...
public class ConnectedPlayersHandler extends FunctionInvoker<Input, Report<?>> {

	@FunctionName("v1StatsConnectedPlayers247FFA")
	public HttpResponseMessage execute(
			@HttpTrigger(name = "request", route = "v1/stats/reports/247ffa_player_history", methods = {
