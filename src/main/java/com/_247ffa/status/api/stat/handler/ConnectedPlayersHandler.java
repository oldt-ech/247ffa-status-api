...
public class ConnectedPlayersHandler extends FunctionInvoker<StatFilter, Report<?>> {

	@FunctionName("v1statsplayers")
	public HttpResponseMessage execute(@HttpTrigger(name = "request", route = "v1/stats/reports/247ffa_player_history", methods = {
