...
public class PopularMapsHandler extends FunctionInvoker<Input, Report<?>> {

	@FunctionName("v1StatsPopularMaps247FFA")
	public HttpResponseMessage execute(@HttpTrigger(name = "request", route = "v1/stats/reports/247ffa_map_history", methods = {
